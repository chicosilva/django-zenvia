# coding=utf-8
from zenvia.humansms.bean.Response import Response
from zenvia.humansms.util.HumanHTTPHelper import HumanHTTPHelper
import httplib
import urllib
...
class HumanConnectionHelper:
    ...
    def sendRequest(self, params):
        ...
        headers = {"Content-type": "%s;%s" % (params["ContentType"], "charset=utf-8"), "Accept": params["Accept"]}
        ...
        param = urllib.urlencode(str_mp3_data)
